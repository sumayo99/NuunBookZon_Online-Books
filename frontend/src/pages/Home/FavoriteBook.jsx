  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='space-y-6 md:w-1/2'>
            <h2 className='text-5xl my-5 font-bold md:w-3/4 leading-snug'>Discover Books <span className='text-blue-600'  style={{ color: '#6875F5' }} > with Our Partners</span></h2>
            <p className='mb-10 text-lg md:w-5/6'>Wax badan ka ogoow maktabadaha aan shaqo wadaaga nahay io mashruucyada kala duwan ee aan ka qeyb qaadanay</p>
